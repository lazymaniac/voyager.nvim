...
callers (references and incoming calls) appear above the symbol they were run
from, while definitions, declarations, implementations, type definitions, and
outgoing calls appear below it.
